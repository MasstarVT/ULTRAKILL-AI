...
override is `speed.rewards: {death: 12.0, oob: 0.035}` (2026-09-20, -22; `fall_hp: 0.04` was a third line for
round 15 only, set and REVERTED 2026-09-23 as inert), and the first test in this file is the pin that says so:
every lever here is DORMANT, and turning one on is a line in `configs/specialists.yaml`, never a code change.
...
def test_the_shipped_plan_ships_no_train_or_env_override():
    ...
    assert p.speed_rewards == {"death": 12.0, "oob": 0.035}, \
        "the 2026-09-20 death weight and the 2026-09-22 oob weight, and no other (fall_hp REVERTED 2026-09-23)"
